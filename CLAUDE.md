...
**Phase 1 目标**（待完成，无 commits）：

```
cairn/
├── README.md
├── spec/
│   ├── FORMAT.md               # 三层完整格式规范（下一步重点）
│   ├── DESIGN.md               # 设计决策文档（源自 docs/design.md）
...
Phase 2（CLI）和 Phase 3（MCP Server）在 `cli/` 目录下，尚未开始。
...
完整设计在 `docs/design.md`，三层架构已确定，下一步是产出 `spec/FORMAT.md`。

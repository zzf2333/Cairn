...
## [0.4.12] - 2026-06-09 (Skill bootstrap guard)

This patch corrects the global instruction design introduced in the 0.4.10 line: global instructions now act only as a short bootstrap guard for the Cairn Skill, while the Skill remains the owner of lifecycle behavior.
...
- `npm test -- tests/cli/global-instructions.test.ts` — bootstrap contract test passing.
